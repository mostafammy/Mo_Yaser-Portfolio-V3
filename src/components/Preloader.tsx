    ...
    <AnimatePresence>
      {loading && (
        ...
        >
          ...
          <div className="relative z-10 w-full h-full flex flex-col bg-[#020202] overflow-hidden">
            ...
            <div className="flex-1 relative z-20 flex flex-col items-center justify-center p-4 overflow-hidden">
              ...
              <div className="flex flex-col items-center justify-center pointer-events-none w-full max-w-xl">
                <motion.div
                  ...
                  className="text-[clamp(2rem,5.5vw,4.5rem)] font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 mb-6 sm:mb-8 text-center select-none"
                  style={{
                ...
                >
                  ...
                  <div 
                    className="relative w-28 h-28 sm:w-36 sm:h-36 flex items-center justify-center rounded-full"
                    style={{
