            ...
            >
              <div
                ...
                style={{
                  ...
                  filter:
                    scale > 1.2
                      ? `drop-shadow(0 ${Math.max(2, baseIconSize * 0.05)}px ${Math.max(4, baseIconSize * 0.1)}px rgba(0,0,0,${0.2 + (scale - 1) * 0.15}))`
                      : `drop-shadow(0 ${Math.max(1, baseIconSize * 0.03)}px ${Math.max(2, baseIconSize * 0.06)}px rgba(0,0,0,${0.2 + (scale - 1) * 0.15}))`,
                  color: "white",
                }}
              >
                {app.icon}
